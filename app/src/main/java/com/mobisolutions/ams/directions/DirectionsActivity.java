package com.mobisolutions.ams.directions;
...
/**
 * Created by vkilari on 10/24/17.
 */
...
public class DirectionsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean permissionRequest = checkLocationPermission();
    ...
    private String downloadUrl(String strUrl) throws IOException {
        ...
        try{
            ...
            Log.d("ownloading url", e.toString());
        }finally{
            iStream.close();
